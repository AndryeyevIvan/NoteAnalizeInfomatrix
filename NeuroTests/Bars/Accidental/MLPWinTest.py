...
net = nn()
net.load(path=r"C:\Users\Иван\Downloads\accidentals_full_mlp1_epoch_2_loss_0.02.json")
...
for note, start, end, score in filteredEvents:
    for t in range(start, end):
        ...
        cv2.putText(img_big, notes[note],(5, 80), cv2.FONT_HERSHEY_SIMPLEX,1.2,(0, 255, 0),3)
